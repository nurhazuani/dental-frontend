...
<br>
              ...
              <b-col cols="12">
                <b-card align="left" bg-variant="grey" text-variant="black" header="Profile Detail"
                 v-for="(staff) in users" :key="staff.uid">
                   <form >
                            <div class="form-group">
                            <b-input-group>Staff ID :
                                    <input
                                        v-model="form.uid"
                                        type="text"
                                        class="form-control"
                ...
                <b-card align="left" bg-variant="grey" text-variant="black" header="Update Password" 
                 v-for="(staff) in users" :key="staff.uid">
                   <form >
                           ...
                           <b-button variant="info" type="submit" v-if="form.uname" @click="onHandLeUpdate()">Change</b-button>
...
export default {
   ...
   mounted(){
       ...
       methods: {
            ...
            onHandLeUpdate(){
              var uid = this.form.uid
              this.$http.patch(`http://localhost:3000/users/${uid}`, this.form)
                                  .then(() => {
                                      this.form ={
                                        uid:'',
                                        uname: '',
